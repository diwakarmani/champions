-- Fix property images v2: replace ALL images with VERIFIED working Unsplash IDs only.
-- All IDs below confirmed HTTP 200. Broken IDs (1560448075, 1574362848787,
-- 1613977257363, 1564013799919, 1580587771525) have been removed.
  ...
  image_url = CASE
    WHEN pt.name = 'Apartment' THEN
      CASE ((pi.property_id + pi.display_order) % 4)
        WHEN 0 THEN 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80&auto=format&fit=crop'
        WHEN 1 THEN 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80&auto=format&fit=crop'
    ...
    WHEN pt.name = 'Villa' THEN
      CASE ((pi.property_id + pi.display_order) % 4)
        ...
        WHEN 1 THEN 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80&auto=format&fit=crop'
        WHEN 2 THEN 'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=800&q=80&auto=format&fit=crop'
        ELSE       'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80&auto=format&fit=crop'
      END
    ...
    ELSE  -- Independent House + any other type
      CASE ((pi.property_id + pi.display_order) % 6)
        ...
        WHEN 2 THEN 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80&auto=format&fit=crop'
        WHEN 3 THEN 'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=800&q=80&auto=format&fit=crop'
        WHEN 4 THEN 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&q=80&auto=format&fit=crop'
        ELSE       'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80&auto=format&fit=crop'
      END
  END,
  thumbnail_url = CASE
    WHEN pt.name = 'Apartment' THEN
      CASE ((pi.property_id + pi.display_order) % 4)
        WHEN 0 THEN 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=400&q=70&auto=format&fit=crop'
        WHEN 1 THEN 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=400&q=70&auto=format&fit=crop'
    ...
    WHEN pt.name = 'Villa' THEN
      CASE ((pi.property_id + pi.display_order) % 4)
        ...
        WHEN 1 THEN 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=70&auto=format&fit=crop'
        WHEN 2 THEN 'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=400&q=70&auto=format&fit=crop'
        ELSE       'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&q=70&auto=format&fit=crop'
      END
    WHEN pt.name = 'Penthouse' THEN
      CASE ((pi.property_id + pi.display_order) % 4)
    ...
    ELSE
      CASE ((pi.property_id + pi.display_order) % 6)
        ...
        WHEN 2 THEN 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=400&q=70&auto=format&fit=crop'
        WHEN 3 THEN 'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=400&q=70&auto=format&fit=crop'
        WHEN 4 THEN 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=400&q=70&auto=format&fit=crop'
        ELSE       'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=70&auto=format&fit=crop'
      END
  END
FROM properties p
